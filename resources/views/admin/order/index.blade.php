            ...
            <tr>
                ...
                <td class="py-3">
                    <div class="flex items-center gap-3">
                        <a href="{{route('admin.transaction', $order->id)}}" class="rounded-full bg-green-500 text-gray-300 px-3 py-2">
                            Payment
                        </a>
                        <a href="{{route('admin.cancel.order', $order->id)}}" data-confirm-delete="true" class="rounded-full bg-red-500 text-gray-300 px-3 py-2">
                            Cancel Order
                        </a>
                    </div>
                </td>
