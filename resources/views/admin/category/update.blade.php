    ...
    <form action="{{route('category.update', $category->id)}}" method="post">
        ...
        <div class="input-group">
            ...
            <textarea name="desc" rows="5"
                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 rounded-lg border border-gray-200 bg-transparent py-2.5 pr-14 pl-3 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden xl:w-[430px] dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30">{{$category->desc}}</textarea>
        </div>
